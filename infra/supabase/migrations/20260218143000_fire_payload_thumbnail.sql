-- Include post thumbnail/display URLs in fire alert payload for card rendering
...
begin
  ...
  insert into public.fire_alerts (
    ...
    layer_key, confidence, percentile_tag, percentile_performance, updated_at
  )
  values (
    ...
    v_layer, v_confidence, v_tag, v_pct, now()
  )
