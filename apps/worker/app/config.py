...
# --- Signal Intelligence (LLM fingerprints + signal cards) ---
SIGNAL_INTELLIGENCE_PROVIDER = (
    _get_env("SIGNAL_INTELLIGENCE_PROVIDER", _get_env("POST_INTELLIGENCE_PROVIDER", "auto")).strip().lower()
    or "auto"
)
...
SIGNAL_INTELLIGENCE_REPAIR_MODEL = _get_env("SIGNAL_INTELLIGENCE_REPAIR_MODEL", "google/gemini-3-flash-preview")
...
SIGNAL_INTELLIGENCE_ESCALATION_MODEL = _get_env("SIGNAL_INTELLIGENCE_ESCALATION_MODEL", FOCUS_COMPILER_MODEL)
...
FOCUS_V2_SLICES_ENABLED = _get_bool_env("FOCUS_V2_SLICES_ENABLED", False)
