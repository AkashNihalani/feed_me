...
POST_BREAKDOWN_MODEL = _get_env("POST_BREAKDOWN_MODEL", "anthropic/claude-sonnet-4.6")
...
FEEDER_FILE_COMPILER_MODEL = _get_env("FEEDER_FILE_COMPILER_MODEL", "anthropic/claude-sonnet-4.6")
FEEDER_FILE_PATTERN_MODEL = _get_env("FEEDER_FILE_PATTERN_MODEL", "anthropic/claude-sonnet-4.6")
FEEDER_FILE_PROOF_MODEL = _get_env("FEEDER_FILE_PROOF_MODEL", "anthropic/claude-sonnet-4.6")
FEEDER_FILE_MEMORY_LIMIT = int(_get_env("FEEDER_FILE_MEMORY_LIMIT", "100"))
FEEDER_FILE_MEMORY_DAYS = int(_get_env("FEEDER_FILE_MEMORY_DAYS", "90"))
FEEDER_FILE_RETENTION_PERCENTILE_MAX = float(_get_env("FEEDER_FILE_RETENTION_PERCENTILE_MAX", "40"))
FEEDER_FILE_SLOT_BATCH_PERCENT = int(_get_env("FEEDER_FILE_SLOT_BATCH_PERCENT", "10"))
FEEDER_FILE_ACTIVE_POST_LIMIT = int(_get_env("FEEDER_FILE_ACTIVE_POST_LIMIT", "30"))
FEEDER_FILE_WINNER_SLOT_TARGET = int(_get_env("FEEDER_FILE_WINNER_SLOT_TARGET", "20"))
FEEDER_FILE_RECENT_CONTEXT_TARGET = int(_get_env("FEEDER_FILE_RECENT_CONTEXT_TARGET", "10"))
FEEDER_FILE_WINNER_PERCENTILE_MAX = float(_get_env("FEEDER_FILE_WINNER_PERCENTILE_MAX", "30"))
