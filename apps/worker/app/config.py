...
HEALTHCHECK_RETRY_SPIKE_THRESHOLD = int(_get_env("HEALTHCHECK_RETRY_SPIKE_THRESHOLD", "8"))
HEALTHCHECK_STUCK_MINUTES = int(_get_env("HEALTHCHECK_STUCK_MINUTES", "20"))
HEALTHCHECK_FAILED_LOOKBACK_MINUTES = int(_get_env("HEALTHCHECK_FAILED_LOOKBACK_MINUTES", "30"))
