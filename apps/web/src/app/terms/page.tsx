  ...
  return (
    <main className="min-h-screen bg-[var(--fm-page)] px-6 py-12 text-[#111] dark:text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-[-0.04em]">Terms of Service</h1>
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-foreground/72 dark:text-white/66">
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.14em] text-foreground dark:text-white">Subscription</h2>
          ...
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.14em] text-foreground dark:text-white">Usage</h2>
          ...
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.14em] text-foreground dark:text-white">Billing Support</h2>
          ...
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.14em] text-foreground dark:text-white">Availability</h2>
