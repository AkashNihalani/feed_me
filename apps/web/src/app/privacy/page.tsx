  ...
  return (
    <main className="min-h-screen bg-[#f4f7f9] px-6 py-12 text-[#111] dark:bg-[#030303] dark:text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-[-0.05em]">Privacy Policy</h1>
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-foreground/72 dark:text-white/66">
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.12em] text-foreground dark:text-white">What We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.12em] text-foreground dark:text-white">How We Use It</h2>
          ...
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.12em] text-foreground dark:text-white">Payments</h2>
          ...
          <section>
            <h2 className="text-base font-black uppercase tracking-[0.12em] text-foreground dark:text-white">Support</h2>
