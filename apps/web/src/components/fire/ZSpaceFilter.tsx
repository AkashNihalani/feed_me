      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className={cn(
              'relative z-10 mb-0 flex w-full max-w-2xl flex-col overflow-hidden rounded-t-[34px] sm:mb-12 sm:rounded-[34px]',
          ...
          >
            ...
            <div className="relative z-10 flex max-h-[85vh] flex-col gap-8 overflow-y-auto px-6 py-8 sm:px-8 sm:py-9">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="text-[10px] font-black uppercase tracking-[0.22em] text-black/50 dark:text-white/40">
                    Feed List
                  </div>
                  <div className="mt-2 text-[22px] font-black uppercase tracking-[0.14em] text-black dark:text-white">
                    Feed Filter
                  </div>
                  <div className="mt-2 text-[12px] font-black uppercase tracking-[0.14em] text-black/36 dark:text-white/30">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.94 }}
                  onClick={onClose}
                  className="rounded-[18px] border border-white/70 bg-white/60 p-2.5 text-black/55 shadow-[0_2px_6px_rgba(0,0,0,0.08),0_1px_0_rgba(255,255,255,0.9)_inset] dark:border-white/10 dark:bg-white/[0.06] dark:text-white/46 dark:shadow-[0_2px_8px_rgba(0,0,0,0.4),0_1px_0_rgba(255,255,255,0.06)_inset]"
                >
                    ...
                    return (
                      <motion.button
                        ...
                        className={cn(
                          ...
                          isActive
                            ? 'bg-black text-white shadow-[0_4px_16px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.1)] dark:bg-[var(--fm-accent)] dark:text-white dark:shadow-[0_4px_20px_rgb(var(--fm-accent-rgb)/0.2),inset_0_1px_2px_rgba(255,255,255,0.5)]'
                      ...
                      >
                        <span className="text-[14px] font-black tracking-[0.14em]">{option.label}</span>
                      </motion.button>
                    );
                  })}
                </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div
                  className="flex max-h-[280px] flex-col gap-2 overflow-y-auto rounded-[22px] p-1.5 hide-scrollbar"
                        ...
                        <div className="flex items-center gap-2">
                          <motion.button
                            ...
                            className={cn(
                              ...
                              isSelected
                                ? 'border border-black/5 bg-white text-black shadow-[0_4px_16px_rgba(0,0,0,0.08),inset_0_1px_1px_rgba(255,255,255,0.9)] dark:border-white/10 dark:bg-black dark:text-[var(--fm-accent)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.05)]'
                                : 'text-black/60 dark:text-white/52',
                            )}
                          >
                            <div className="min-w-0">
                              <div className="truncate text-[16px] font-black tracking-tight sm:text-[16px]">
                                {feed.name}
                              </div>
                              <div className="mt-1 text-[10px] font-black uppercase tracking-[0.14em] text-black/35 dark:text-white/28">
                            ...
                            {isSelected && (
                              <div className="ml-3 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-black/5 dark:bg-[var(--fm-accent)]/10">
                                <Check size={14} strokeWidth={4} className="text-black dark:text-[var(--fm-accent)]" />
                              </div>
                            )}
                          </motion.button>
                                ...
                                return (
                                  <motion.button
                                    ...
                                    className={cn(
                                      ...
                                      isFeederSelected
                                        ? 'bg-[var(--fm-accent)] text-white shadow-[0_8px_18px_rgb(var(--fm-accent-rgb)/0.26),inset_0_1px_0_rgba(255,255,255,0.7)]'
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-2.5">
                  <motion.button
                    ...
                    className={cn(
                      'rounded-[18px] px-4 py-3 text-[12px] font-black uppercase tracking-[0.14em] transition-colors duration-200',
                  ...
                  {availableCheckpoints.length === 0 && (
                    <div className="rounded-[18px] border border-dashed border-black/8 px-4 py-3 text-[10px] font-black uppercase tracking-[0.14em] text-black/35 dark:border-white/10 dark:text-white/30">
              ...
              <div className="pt-1">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={cn(
                    'group relative w-full overflow-hidden rounded-[22px] py-5',
                    'bg-black shadow-[0_8px_24px_rgba(0,0,0,0.2),inset_0_1px_2px_rgba(255,255,255,0.2)]',
                    'dark:bg-[var(--fm-accent)] dark:shadow-[0_8px_32px_rgb(var(--fm-accent-rgb)/0.25),inset_0_1px_2px_rgba(255,255,255,0.6)]',
                  )}
                >
                  <span className="relative z-10 text-[16px] font-black uppercase tracking-[0.14em] text-white">
                    Find Your Fire
                  </span>
                </motion.button>
              </div>
