...
import { PANEL_STAGGER_CONTAINER, PANEL_TILE_VARIANT } from '@/lib/motion';
...
const staggerContainer = PANEL_STAGGER_CONTAINER;
const tileVariant = PANEL_TILE_VARIANT;
...
export default function FundPage() {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {showManageSubscriptionModal && (
          <motion.div
            ...
            transition={{
              scale: { type: 'spring', stiffness: 104, damping: 24, mass: 1.18 },
              opacity: { duration: 0.22, ease: [0.22, 1, 0.36, 1] },
            }}
            className="fm-chrome-safe-overlay fixed inset-0 z-[420] flex items-end justify-center sm:items-center sm:px-4 sm:py-6"
          ...
          >
            ...
            <motion.div
              ...
              transition={{
                y: { type: 'spring', stiffness: 120, damping: 24, mass: 1.08 },
                scale: { type: 'spring', stiffness: 120, damping: 24, mass: 1.08 },
                opacity: { duration: 0.2, ease: [0.22, 1, 0.36, 1] },
              }}
              onClick={(event) => event.stopPropagation()}
              className="fm-fund-breakdown-dialog fm-dark-scrollbar relative z-10 w-full max-h-[92vh] overflow-y-auto overflow-x-hidden sm:max-w-[520px] sm:rounded-[28px]"
              style={{
                background: '#080808',
            ...
            >
              ...
              <div className="fm-fund-breakdown-ledger px-5 pt-5 sm:px-7 sm:pt-6">
                ...
                {billingSummary.overages.length > 0 ? (
                  <div className="fm-fund-breakdown-ledger-list fm-dark-scrollbar space-y-1.5 sm:space-y-2">
              ...
              {/* ── Add feeder CTA ── */}
              <div className="fm-fund-breakdown-cta px-5 pb-6 pt-5 sm:px-7 sm:pb-7 sm:pt-6">
                <button
                  type="button"
              ...
              <div className="fm-fund-breakdown-mobile-safe h-[env(safe-area-inset-bottom)]" />
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
        <div className="relative z-10 px-3.5 sm:px-5 lg:flex lg:h-full lg:flex-col lg:justify-center lg:px-5">
          <div className="fm-app-header-row flex">
