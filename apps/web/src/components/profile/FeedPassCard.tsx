...
function FeedMeLogo({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect x="70" y="70" width="372" height="372" rx="88" stroke="white" strokeWidth="28" />
  ...
  return (
    <div className="w-full" style={{ perspective: '3000px' }}>
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: '0 22px 64px rgba(204,255,0,0.14), 0 8px 24px rgba(0,0,0,0.42)',
          }}
        >
          <div
            ...
            style={{
              background:
                'linear-gradient(140deg, #334600 0%, #5d8500 20%, #8fca00 38%, #557100 58%, #314100 76%, #182000 100%)',
            }}
          />
          <div
            className="absolute inset-0"
            style={{
              background: `
                radial-gradient(ellipse 96% 82% at ${42 + Math.sin(time * 0.32) * 12}% ${48 + Math.cos(time * 0.35) * 12}%, rgba(204,255,0,0.54) 0%, transparent 66%),
                radial-gradient(ellipse 72% 58% at ${72 + Math.cos(time * 0.25) * 16}% ${26 + Math.sin(time * 0.28) * 18}%, rgba(230,255,100,0.34) 0%, transparent 54%),
                radial-gradient(ellipse 58% 62% at ${24 + Math.sin(time * 0.41) * 13}% ${72 + Math.cos(time * 0.23) * 10}%, rgba(170,236,0,0.3) 0%, transparent 52%)
              `,
            }}
          />
          <div
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(56deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0) 26%, rgba(204,255,0,0.16) 38%, rgba(255,255,255,0.34) 50%, rgba(204,255,0,0.16) 62%, rgba(255,255,255,0) 74%, rgba(255,255,255,0) 100%)',
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-between p-5 sm:p-6 lg:p-6 xl:p-7">
              <div className="flex items-center justify-between gap-3">
                <span className="text-[13px] font-black uppercase tracking-[0.16em] text-[#efffc1] sm:text-[15px] lg:text-[17px] xl:text-[18px]" style={{ textShadow: '0 0 18px rgba(204,255,0,0.55)' }}>
                  Feed Pass
                </span>
                <div className="flex items-center gap-1.5 rounded-full border border-white/14 bg-white/10 px-3 py-1.5 backdrop-blur-[8px]">
                  <div className="h-[7px] w-[7px] rounded-full bg-[#CCFF00] shadow-[0_0_8px_rgba(204,255,0,0.85)] feedpass-dot-pulse" />
              ...
              <div className="flex flex-1 items-end justify-end">
                <div className="text-right">
                  <div
                    ...
                    style={{ textShadow: '0 0 60px rgba(204,255,0,0.34), 0 0 120px rgba(204,255,0,0.14), 0 2px 4px rgba(0,0,0,0.45)' }}
                  >
                    {feederCount}
                  </div>
                  <div className="mt-1 text-[11px] font-black uppercase tracking-[0.15em] text-[#f2ffc8]/68 sm:text-[13px] lg:text-[14px] xl:text-[15px]">
                    Active Feeders
                  </div>
                </div>
              </div>
        ...
        <div
          ...
          style={{
            ...
            boxShadow: '0 22px 64px rgba(0,0,0,0.55), 0 0 40px rgba(204,255,0,0.06)',
          }}
        >
          ...
          <div className="absolute inset-0 z-10 flex flex-col justify-between p-5 sm:p-6 lg:p-7">
            ...
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-black uppercase tracking-[0.18em] text-white/28 sm:text-[11px]">
                Billing summary
              </span>
              <span className="text-[9px] font-bold uppercase tracking-[0.14em] text-white/22 sm:text-[10px]">
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              <div className="flex items-baseline justify-between">
                <div className="text-[10px] font-black uppercase tracking-[0.14em] text-white/32 sm:text-[11px]">Base cost</div>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[18px] font-black tracking-[-0.03em] text-white/80 sm:text-[22px]">
                    ₹{billing.baseCost.toLocaleString('en-IN')}
                  </span>
                  <span className="text-[8px] font-bold uppercase tracking-[0.1em] text-white/20 sm:text-[9px]">
              ...
              <div className="flex items-baseline justify-between">
                <div className="text-[10px] font-black uppercase tracking-[0.14em] text-white/32 sm:text-[11px]">Overages</div>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[18px] font-black tracking-[-0.03em] text-white/80 sm:text-[22px]">
            ...
            <div
              className="flex items-center justify-between rounded-[16px] sm:rounded-[18px] bg-[#CCFF00] px-4 py-3 sm:py-3.5"
              style={{ boxShadow: '0 8px 32px rgba(204,255,0,0.18), 0 0 60px rgba(204,255,0,0.08)' }}
            >
              <div>
                <div className="text-[8px] font-black uppercase tracking-[0.14em] text-black/45 sm:text-[9px]">Total this cycle</div>
                <div className="text-[28px] font-black leading-none tracking-[-0.05em] text-black sm:text-[34px]">
                  ₹{billing.total.toLocaleString('en-IN')}
                </div>
              </div>
              <div className="text-right">
                <div className="text-[8px] font-black uppercase tracking-[0.12em] text-black/35 sm:text-[9px]">{slotPostsCap} posts</div>
                <div className="text-[7px] font-bold uppercase tracking-[0.1em] text-black/25 sm:text-[8px]">incl. per feeder</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-white/[0.08] sm:h-7 sm:w-7">
                  <ArrowUpRight size={12} className="text-white/50" />
                </div>
                <span className="text-[9px] font-black uppercase tracking-[0.12em] text-white/36 sm:text-[10px]">
                  Full breakdown
                </span>
              </button>
              <span className="text-[7px] font-bold uppercase tracking-[0.12em] text-white/16 sm:text-[8px]">tap to flip</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <style>{`
        ...
        .feedpass-stars-small {
          background-image:
            radial-gradient(1px 1px at 20px 30px, rgba(204,255,0,0.74), transparent),
            radial-gradient(1px 1px at 40px 70px, rgba(255,255,255,0.9), transparent),
            radial-gradient(1px 1px at 50px 160px, rgba(204,255,0,0.7), transparent),
            radial-gradient(1px 1px at 90px 40px, rgba(255,255,255,0.85), transparent),
            radial-gradient(1px 1px at 130px 80px, rgba(224,255,124,0.6), transparent),
        ...
        .feedpass-stars-medium {
          background-image:
            radial-gradient(1.5px 1.5px at 150px 150px, rgba(204,255,0,0.68), transparent),
            radial-gradient(1.5px 1.5px at 220px 220px, rgba(255,255,255,0.88), transparent),
            radial-gradient(1.5px 1.5px at 80px 250px, rgba(221,255,94,0.62), transparent),
        ...
        .feedpass-stars-large {
          background-image:
            radial-gradient(2px 2px at 100px 100px, rgba(204,255,0,0.75), transparent),
            radial-gradient(2px 2px at 200px 200px, rgba(255,255,255,0.92), transparent),
            radial-gradient(2px 2px at 300px 300px, rgba(204,255,0,0.62), transparent);
        ...
        .feedpass-stars-twinkle {
          background-image:
            radial-gradient(2px 2px at 50px 50px, rgba(204,255,0,0.86), transparent),
            radial-gradient(2px 2px at 150px 150px, rgba(255,255,255,0.84), transparent),
            radial-gradient(2px 2px at 250px 250px, rgba(225,255,116,0.82), transparent);
          background-size: 300px 300px;
          opacity: 0;
        ...
        .feedpass-particles {
          ...
          height: 100%;
          background-image:
            radial-gradient(1px 1px at 10% 10%, rgba(204,255,0,0.72), transparent),
            radial-gradient(1px 1px at 25% 25%, rgba(255,255,255,0.58), transparent),
            radial-gradient(1px 1px at 40% 40%, rgba(204,255,0,0.64), transparent),
            radial-gradient(1px 1px at 55% 55%, rgba(255,255,255,0.5), transparent),
            radial-gradient(1px 1px at 70% 70%, rgba(204,255,0,0.62), transparent),
            radial-gradient(1px 1px at 85% 85%, rgba(255,255,255,0.46), transparent),
            radial-gradient(1px 1px at 95% 15%, rgba(204,255,0,0.56), transparent),
        ...
        @keyframes feedpass-dot-pulse {
          0%, 100% { box-shadow: 0 0 4px rgba(204,255,0,0.6); }
          50% { box-shadow: 0 0 10px rgba(204,255,0,1), 0 0 20px rgba(204,255,0,0.4); }
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          ...
          .feedpass-dot-pulse { box-shadow: 0 0 6px rgba(204,255,0,0.8); }
        }
      `}</style>
    </div>
  );
